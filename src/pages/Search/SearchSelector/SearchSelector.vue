  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="trademark in trademarkList" :key="trademark.id" @click="addTrademark(trademark)">{{trademark.tmName}}</li>
    ...
    <div class="type-wrap" v-for="attr in attrsList" :key="attr.Id">
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="attrValue in attr.attrValueList" :key="attrValue" @click="addAttrs(attr,attrValue)">
            <a>{{attrValue}}</a>
          </li>
        </ul>
      </div>
