            ...
            <div class="chooseArea">
              ...
              >
                ...
                <dd
                  ...
                  @click="changeChecked(spuSaleAttr, index)"
                >
...
export default {
  ...
  methods: {
    getGoodDetail() {
      this.$store.dispatch("detail/getGoodDetail", this.$route.params.id);
    },
    changeChecked(attr, index) {
      // console.log(attr);
      attr.spuSaleAttrValueList.forEach((ele) => {
        ele.isChecked = "0";
      });
      attr.spuSaleAttrValueList[index].isChecked = "1";
    },
    increase() {
    ...
    addToCart(){
      const req=this.$store.dispatch('detail/updateCart',{skuId:this.$route.params.id,skuNum:this.amount})
      req.then((result)=>{
        this.$router.push({path:`/addToCartSuccess`,query:{skuInfo:JSON.stringify(this.skuInfo),spuSaleAttrList:JSON.stringify(this.spuSaleAttrList),skuNum:this.amount,}})
      },(reason)=>{
        alert('请求失败')
      })
    }
