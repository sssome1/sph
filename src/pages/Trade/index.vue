...
export default {
  ...
  computed: {
    ...
    ...mapGetters("trade", ["totalAmount", "totalNum", "orderList", "tradeNo"]),
    selectedAddress() {
      return this.addressList.find((ele) => ele.isDefault == 1) || {};
    },
  },
  mounted() {
