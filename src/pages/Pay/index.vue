      ...
      <div class="checkout-tit">
        ...
        <div class="paymark">
          ...
          <span class="fr"
            ...
            ><em class="orange money">￥{{ this.totalFee }}</em></span
          >
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    async open() {
      let result=await qrcode.toDataURL(this.codeUrl);
      this.$alert(`<img src="${result}" />`, "请使用微信支付", {
